...
%say that it is not completely artificial. there are in built in biases in the developers and algorithms in the
%data used to train it. can we trust
%the training to be 100% unbiased
\\
...
%can we trust who manages the algorithms and the collected data?
...
%
%is it ethical to bring medical hostory into the algorithm? may be iseful to look for people with mental stability
%issues or drug abuse. would this make (admin mentioned something, generally mentail issues)
...
%such systems woiod ne3d to focus on fewer crimes
